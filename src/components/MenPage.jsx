...
function MenPage({ theme, setTheme, themes }) {
  ...
  const FilterSidebar = ({ isModal = false }) => (
  ...
  return (
    <div className="min-h-screen bg-base-100">
              ...
              {filteredProducts.map((product) => (
                <div key={product.id} className="card bg-base-100 shadow-sm hover:shadow-lg transition-shadow cursor-pointer">
                  ...
                  <div className="card-body p-4">
                    ...
                    <h3 className="card-title text-base font-medium line-clamp-2">{product.name}</h3>
      ...
      {/* Mobile Filter Modal */}
      <div className={`modal ${showMobileFilters ? 'modal-open' : ''}`}>
        <div className="modal-box w-11/12 max-w-lg max-h-screen">
